...
export const ButtonGradientOutlineStyle = styled(Base)`
  ...
  background-image: linear-gradient(rgba(255, 255, 255, 0), rgba(255, 255, 255, 0)),
    linear-gradient(93.58deg, #298b5a -105.35%, #6e7210 103.54%);
...
export const ButtonSwitchStyle = styled(Base)`
  font-family: Inter;
  font-style: normal;
  ...
  line-height: 15px;
  border-radius: 10px;
  color: ${({ active }) => (active ? 'linear-gradient(93.58deg, #3ad889 -105.35%, #f3fc1f 103.54%)' : '#b5b9d3')};
  box-shadow: 0 0 6px 0 rgba(157, 96, 212, 0.5);
  border: solid 2px transparent;
  background-image: linear-gradient(rgba(255, 255, 255, 0), rgba(255, 255, 255, 0)),
    linear-gradient(93.58deg, #298b5a -105.35%, #6e7210 103.54%);
  background-origin: border-box;
  background-clip: content-box, border-box;
  box-shadow: ${({ active }) => (active ? '2px 1000px 1px #242637 inset' : 'none')};
  background: ${({ active }) => (active ? 'linear-gradient(93.58deg, #3ad889 -105.35%, #f3fc1f 103.54%)' : '#0b0c13')};
